...
<pre> FasterRCNN-Pytorch ├── VOC2007 │ ├── JPEGImages │ └── Annotations ├── VOC2007-test │ ├── JPEGImages │ └── Annotations ├── tools │ ├── train.py │ ├── infer.py │ ├── train_torchvision_frcnn.py │ └── infer_torchvision_frcnn.py ├── config │ └── voc.yaml ├── model │ └── faster_rcnn.py └── dataset └── voc.py </pre>
