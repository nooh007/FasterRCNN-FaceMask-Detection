...
def load_model_and_dataset(args):
    ...
    if args.use_resnet50_fpn:
        faster_rcnn_model = torchvision.models.detection.fasterrcnn_resnet50_fpn(weights=ResNet50_Weights.IMAGENET1K_V1,
                                                                                 min_size=600,
                                                                                 max_size=1000,
        ...
        backbone = torchvision.models.resnet34(weights=ResNet34_Weights.IMAGENET1K_V1, norm_layer=torchvision.ops.FrozenBatchNorm2d)
